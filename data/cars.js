(function carDataModule(root, factory) {
  ...
  const cars = [
    ...
    },
    {
      ...
      evidence: "verified",
      verifiedAt: "2026-08-28",
      sourceUrl: "https://www.coches.net/honda/hrv/hibrido/segunda-mano/",
      sourceLabel: "Coches.net · Honda HR-V e:HEV ocasión",
      ...
      trunkL: "319 l",
      seats: 5,
      warranty: "5 años oficial / Cobertura Honda Care",
      pros: [
    ...
    },
    {
      ...
      evidence: "verified",
      verifiedAt: "2026-08-28",
      sourceUrl: "https://www.coches.net/hyundai-kona-16-gdi-hev-maxx-dt-5p-hibrido-2021-en-barcelona-71285250-covo.aspx",
      sourceLabel: "Coches.net · Hyundai Kona HEV Maxx 2021 Barcelona",
    ...
    },
    {
      ...
      priceNote: "26.750 € PVP oficial al contado. Cobertura Honda Care y fiabilidad legendaria.",
    ...
    },
    {
      ...
      evidence: "verified",
      verifiedAt: "2026-08-28",
      sourceUrl: "https://www.renault.es/electricos/r4-e-tech-electrico.html",
      sourceLabel: "Renault España · Gama Oficial Renault 4 E-Tech",
      priceNote: "Tarifa Evolution 120 CV desde 27.954 € al contado (Techno 150 CV 52 kWh en 32.729 €). Como autónomo, potencialmente elegible para Línea 2 Auto+ (pendiente de convocatoria).",
      summary: "El \"Yaris Cross eléctrico francés\": 4,14 m, 5 plazas, 420 l de maletero, 181 mm de altura libre al suelo y umbral de carga bajo. Postura crossover elevada perfecta para entrar y salir con tus padres, con ecosistema OpenR Link con Google integrado en acabados superiores.",
    ...
    },
    {
      ...
      sourceLabel: "Nissan España · Tienda Online Stock Micra EV",
      priceNote: "Stock oficial Nissan España al contado: Acenta (317 km) en 20.600 €, N-Connecta (314 km) en 23.000 € y N-Connecta (415 km) en 25.650–26.250 €.",
      summary: "La alternativa eléctrica más redonda por 23k € al contado: 3,97 m, 5 puertas y 5 plazas, 326 l de maletero, ecosistema Google integrado, gran suavidad de conducción y la garantía Nissan+ extensible hasta 10 años o 200.000 km.",
      ...
      trunkL: "326 l",
      seats: 5,
      warranty: "Nissan+ extensible hasta 10 años / 200.000 km (8 años batería)",
      pros: [
        "Precios de stock oficial al contado muy competitivos (N-Connecta a 23.000 €)",
        "Garantía Nissan+ extensible hasta 10 años o 200.000 km realizando revisiones oficiales",
      ...
      cons: [
        ...
        "Plazas traseras justas para adultos altos en viajes largos"
      ]
    },
    {
      ...
      sourceLabel: "MG Motor España · Tarifa Oficial MG4 Urban 2026",
      priceNote: "Tarifa oficial Comfort 43 kWh LFP desde 25.490 € al contado (sin meter descuentos condicionados a financiación). 7 años de garantía oficial.",
      summary: "La gran renovación del compacto eléctrico: 4,40 m, batería LFP de 42,8 kWh (325 km WLTP), bomba de calor de serie, pantalla central de 12,8\" con Apple CarPlay/Android Auto inalámbrico, hasta 577 l de maletero y 7 años de garantía oficial.",
      ...
      pros: [
        ...
        "Enorme maletero de hasta 577 l y 5 plazas muy amplias",
    ...
    },
    {
      ...
      evidence: "verified",
      verifiedAt: "2026-08-28",
      sourceUrl: "https://www.media.stellantis.com/es-es/leapmotor/press/el-leapmotor-b10-se-estrena-ante-el-publico-espanol-en-el-vem",
      sourceLabel: "Stellantis Media · Lanzamiento Leapmotor B10 España",
      priceNote: "PVP al contado desde 29.900 € (ofertas con financiación desde ~25–26k €). Respaldo oficial de la red Stellantis (65–80 concesionarios).",
      summary: "SUV tecnológico del segmento C respaldado por el grupo Stellantis: 218 CV, pantalla central 14,6\" 2.5K, cámara 360°, suspensión multibrazo y carga rápida hasta 168 kW. Espectacular producto, pero sus 4,52 m de largo penalizan severamente para vuestro uso urbano y garaje.",
      bestFor: "Espectáculo tecnológico, potencia (218 CV) y espacio interior para quien no le importe el tamaño",
      caution: "Mide 4,52 m (+35 cm sobre el tamaño ideal), marca debutante y precio al contado en 29,9k.",
      winner: "📺 Mayor despliegue multimedia (Pantalla 14,6\" 2.5K · 218 CV)",
      rank: 12,
      tier: "B",
      score: 8.35,
      lengthM: "4,52 m",
      ...
      pros: [
        "Potencia sobresaliente de 218 CV y suspensión multibrazo confortable",
        "Pantalla 14,6\" de resolución 2.5K, cámaras 360° y 17 asistentes ADAS",
        "Red de distribución y posventa respaldada por el Grupo Stellantis",
        "Carga ultrarrápida en corriente continua hasta 168 kW"
      ],
      cons: [
        "Mide 4,52 m: excesivamente largo para aparcar en Vallirana/Barcelona y garaje",
        "Tarifa oficial al contado (29.900 €) por encima del presupuesto objetivo de 26k"
      ]
    },
    {
  ...
  const watchlistCars = [
    {
      ...
      batteryKwh: 58.3,
      wltpKm: 436,
      officialPrice: "36.500 € – 41.500 €",
      targetOfferPrice: "≤ 27.000 €",
      lengthM: "4,30 m",
      ...
      status: "Fuera de presupuesto en tarifa (~36,5k €). Si aparece en stock/campaña por ≤27k, pasaría al Top 5 directo.",
      sourceUrl: "https://www.kia.com/es/modelos/ev3/descubrelo/",
      sourceLabel: "Kia Iberia · Gama Oficial EV3"
    },
    {
      ...
      status: "Tarifa oficial en 35.500 € (los anuncios de 20k mezclan financiación, achatarramiento y CAE). Solo viable si aparecen campañas reales al contado ≤26k €.",
  ...
  const budgetGuides = [
    {
      ...
      why: "Fiabilidad legendaria Toyota e-CVT, etiqueta ECO, consumo urbano ridículo (3,9 l/100 km) y mantenimiento ultrasencillo. Mucho más fiable para 10 años que un coche barato nuevo.",
    ...
    },
    {
      ...
      targetPrice: "~22.990 €",
      spendLimit: "Sí",
      why: "Acabado Style con asientos calefactables, pantalla de 9\", clima bizona, sensores completos y garantía oficial Toyota Relax. Alternativa eléctrica: Nissan Micra N-Connecta nuevo en stock por 23.000 € al contado.",
